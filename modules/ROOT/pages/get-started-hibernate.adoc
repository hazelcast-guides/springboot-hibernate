...
[source,xml,indent=0]
----
include::ROOT:example$pom.xml[tag=spring-boot-starter]
----
...
[source,xml,indent=0]
----
include::ROOT:example$pom.xml[tags=hazelcast-hibernate;hazelcast-dep]
----
...
----
include::ROOT:example$src/main/java/com/hazelcast/hibernate/springhibernate2lc/SpringHibernate2lcApplication.java[tag=doc-exclude]
----
...
[source,properties]
----
include::ROOT:example$src/main/resources/application.properties[tag=doc-second-level]
----
...
[source,java]
----
include::ROOT:example$src/main/java/com/hazelcast/hibernate/springhibernate2lc/persistence/Book.java[tag=doc-cachable]
----
